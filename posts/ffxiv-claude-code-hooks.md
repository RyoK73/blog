---
title: FFXIVのSEでClaude Codeを通知するhooksを作ってみた
...
私は5番目の拡張パッケージ「黄金の遺産(レガシー)」リリース直前に開始し、現在はストーリーを攻略中です。
また、2027年1月には第6弾拡張パッケージ「白銀の探求者(ワンダラー)」の発売が予定されています。
...
そこで私は、FFXIVのサウンドエフェクトでClaude Code Hooksを通知するリポジトリを作成しました。

[claude-code-ffxiv-hooks](https://github.com/RyoK73/claude-code-ffxiv-hooks)

本記事ではその経緯と導入方法について解説していきます。

## FFXIV × Claude Codeという体験

FFXIVはストーリーや音楽、独特なゲームプレイが面白い作品です。
漆黒の反逆者からのストーリーは非常に重厚で、私がFFXIVをプレイし始めたきっかけでした。

そんなFFXIVですが、ストーリーやゲーム内システム以外にも、魅力が多くあり、その中の一つが**サウンドエフェクト**(**SE**)です。
...
この素晴らしいSEを開発体験にも活用できないだろうか...

そんな思いつきから、今回このリポジトリを作成するに至りました。
...
ヒカセンであってもなくても、気になった方はぜひ[リポジトリ](https://github.com/RyoK73/claude-code-ffxiv-hooks.git)を覗いてみてください！
